function env = hilbert_transform(x,fs,fc,order,non_linearity)

% HILBERT_TRANSFORM - Performs the envelope extraction
%   env = hilbert_transform(x,fs,fc)
%       Returns the envelope using cutoff frequency fc.
%       The resulting envelope is not normalized.
%   env = hilbert_transform(x,fs,fc,n)
