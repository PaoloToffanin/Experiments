...
amplitudePeriodic = sqrt((1-amplitudeRandom.^2));
...
for ii = 1:length(iPulseLocations)
    ...
    if t1 == t2
        ...
        spectrumSlice = ...
            interp1([t1 t2],[sqFilter(:,floor(temporalPositionIndex(ii))) ...
            sqFilter(:,ceil(temporalPositionIndex(ii)))]',pulseLocations(ii), ...
            'lineear','extrap')';
    end;
    ...
    if t1 == t2
        ...
        ampPulseSlice = ...
            interp1([t1 t2],[ampPulse(:,floor(temporalPositionIndex(ii))) ...
            ampPulse(:,ceil(temporalPositionIndex(ii)))]',pulseLocations(ii), ...
            'lineear','extrap')';
        ampNoiseSlice = ...
            interp1([t1 t2],[ampNoise(:,floor(temporalPositionIndex(ii))) ...
            ampNoise(:,ceil(temporalPositionIndex(ii)))]',pulseLocations(ii), ...
            'lineear','extrap')';
    end;
