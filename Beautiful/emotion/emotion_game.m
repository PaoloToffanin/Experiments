...
%       Buttons 
    ...
    Buttonup.State = 'off';
    [HeightButtonup, WidthButtonup] = size(imread ([options.locationImages 'buttonup_1.png']));
    ...
    [HeightButtondown, WidthButtondown] = size(imread ([options.locationImages 'buttondown_1.png']));
    % ratioscreenbuttons = 0.2 * screen2(4);
    % [HeightButtons, ~] = size(imread ([options.locationImages 'buttons_1.png'));
